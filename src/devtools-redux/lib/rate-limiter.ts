...
export class RateLimiter {
  ...
  updateSettings(minDelay?: number, maxConcurrent?: number): void {
 ...
 */
export const createMetadataRateLimiter = () => new RateLimiter(50, 3)
export const createDataRateLimiter = () => new RateLimiter(100, 5)