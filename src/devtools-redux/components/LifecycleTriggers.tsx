...
export const LifecycleTriggers: React.FC<LifecycleTriggersProps> = ({ className = '' }) => {
  const { triggerInit, triggerUpdateView, triggerDestroy, triggerDestroyAndInit, isInitialized } =
    usePCFLifecycle()
  ...
  return (
    <div
      className={`lifecycle-triggers ${className}`}
      style={{
        padding: '12px',
    ...
    >
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
        ...
        <button
          ...
          style={
            isInitialized
              ? { ...buttonStyle, backgroundColor: '#dc2626', borderColor: '#b91c1c' }
              : buttonStyle
          }
          disabled={!isInitialized || isLoading !== null}
