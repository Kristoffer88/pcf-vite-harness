...
export const PCFDevToolsProvider: React.FC<PCFDevToolsProviderProps> = ({ children, context, manifestInfo }) => {
    ...
    return <PCFDevToolsContext.Provider value={pcfDevTools}>{children}</PCFDevToolsContext.Provider>;
};
